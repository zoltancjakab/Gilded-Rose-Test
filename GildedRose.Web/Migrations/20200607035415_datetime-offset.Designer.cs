...
namespace GildedRose.Web.Migrations
{
    ...
    [Migration("20200607035415_datetime-offset")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GildedRose.Web.Data.DatabaseModels.FileStore.ImageFile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("GildedRose.Web.Data.DatabaseModels.Products.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("de60a276-cc1d-4dfe-aab5-057f0b63fad6"),
                            DateCreated = new DateTimeOffset(new DateTime(2020, 6, 7, 3, 54, 14, 291, DateTimeKind.Unspecified).AddTicks(9746), new TimeSpan(0, 0, 0, 0, 0)),
                            Description = "This Golden Diadem can be worn for many occasions, such as fairs and festivals.",
                            ItemNumber = "0111022342340",
                            Name = "Gold Diadem",
                            StockCount = 27,
                            UnitCost = 29.989999999999998
                        });
                });

            modelBuilder.Entity("GildedRose.Web.Data.DatabaseModels.Products.ProductImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("de61a276-cc1d-4dfe-aab5-057f0b63fad6"),
                            ImageFileId = new Guid("de62a276-cc1d-4dfe-aab5-057f0b63fad6"),
                            Order = 1,
                            ProductId = new Guid("de60a276-cc1d-4dfe-aab5-057f0b63fad6")
                        });
                });

            modelBuilder.Entity("GildedRose.Web.Data.DatabaseModels.Transactions.Transaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GildedRose.Web.Data.DatabaseModels.Users.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GildedRose.Web.Data.DatabaseModels.Products.ProductImage", b =>
                {
                    b.HasOne("GildedRose.Web.Data.DatabaseModels.FileStore.ImageFile", "ImageFile")
                        .WithMany()
                        .HasForeignKey("ImageFileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GildedRose.Web.Data.DatabaseModels.Products.Product", "Product")
            ...
            modelBuilder.Entity("GildedRose.Web.Data.DatabaseModels.Transactions.Transaction", b =>
                {
                    ...
                    b.HasOne("GildedRose.Web.Data.DatabaseModels.Users.User", "User")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("GildedRose.Web.Data.DatabaseModels.Users.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
